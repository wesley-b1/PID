...
static const TickType_t samplingInterval = 100 / portTICK_PERIOD_MS;     // 100ms ou 0.1s
...
void computeU()
{
  ...
  float receberPV; // Receber valor da Fila

  if (xQueueReceive(pvFila, &receberPV, 0) == pdTRUE) // Descarregando o Fila
  {
